...
echo '8000 - '. $u->convert(8000) . '<br />';
echo '8999 - '. $u->convert(8999) . '<br />';
echo '9000 - '. $u->convert(9000) . '<br />';
echo '9999 - '. $u->convert(9999) . '<br />';
echo '10000 - '. $u->convert(10000) . '<br />';
echo '100000 - '. $u->convert(100000) . '<br />';
echo '114545 - '. $u->convert(114545) . '<br />';
echo '999999 - '. $u->convert(999999) . '<br />';
echo '1000000 - '. $u->convert(1000000) . '<br />';
